...
class _GestureWidgetState extends State<GestureWidget> {
  ...
  _GestureWidgetState(){
    if(_ctrlOffset0==null){
      ...
      _ctrlOffset0= Offset(90, ScreenUtil.screenHeightDp/3-60);
    }
    if(_ctrlOffset1==null){
      print("_ctrlOffset1==null");
      _ctrlOffset1=Offset(ScreenUtil.screenWidthDp-90, ScreenUtil.screenHeightDp/3-60);
    }
  } //控制点2
...
class BezierExamplePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    _startOffset=Offset(size.width+60, ScreenUtil.screenHeightDp/3);
    _endOffset=Offset(ScreenUtil.screenWidthDp-60, ScreenUtil.screenHeightDp/3);
